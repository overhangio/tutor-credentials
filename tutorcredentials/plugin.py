...
hooks.Filters.CONFIG_DEFAULTS.add_items(
    [
        ...
        ("CREDENTIALS_CATALOG_API_URL", "{{ OPENEDX_LMS_BASE }}"),
        ...
        ("CREDENTIALS_HOST", "credentials.{{ OPENEDX_LMS_BASE }}"),
        ("CREDENTIALS_LMS_URL", "http://{{ OPENEDX_LMS_BASE }}"),
        ("CREDENTIALS_LMS_URL_ROOT", "http://{{ OPENEDX_LMS_BASE }}"),
        ...
        ("CREDENTIALS_PRIVACY_POLICY_URL", "{{ OPENEDX_LMS_BASE }}/privacy-policy"),
        ("CREDENTIALS_SITE_NAME", "{{ OPENEDX_LMS_BASE }}"),
        ("CREDENTIALS_SOCIAL_AUTH_REDIRECT_IS_HTTPS", False),
        ("CREDENTIALS_SOCIAL_AUTH_EDX_OAUTH2_ISSUER", "https://{{ OPENEDX_LMS_BASE }}"),
        ("CREDENTIALS_SOCIAL_AUTH_EDX_OAUTH2_URL_ROOT", "http://lms:8000"),
        ("CREDENTIALS_SOCIAL_AUTH_EDX_OAUTH2_KEY", "credentials-sso-key"),
        ("CREDENTIALS_SOCIAL_AUTH_EDX_OAUTH2_LOGOUT_URL", "{{ OPENEDX_LMS_BASE }}/logout"),
        ("CREDENTIALS_THEME_NAME", "edx-theme"),
        ("CREDENTIALS_TOS_URL", "{{ OPENEDX_LMS_BASE }}/tos"),
    ]
)
